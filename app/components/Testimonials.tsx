...
export default function Testimonials() {
  ...
  return (
    <>
      ...
      <div className="trustpilot-widget" style={{ marginTop: '20px' }} data-locale="en-US" data-template-id="56278e9abfbbba0bdcd568bc" data-businessunit-id="6921d9a534e60d463bf99720" data-style-height="52px" data-style-width="100%" data-token="6b8b1984-9daf-42bc-a436-109815c1047d">
