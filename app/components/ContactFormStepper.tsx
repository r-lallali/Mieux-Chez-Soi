...
import { motion, AnimatePresence, Variants } from "framer-motion"; // <-- MODIFIÉ

import styles from './ContactFormStepper.module.scss'; // Import CSS Module
          ...
          {currentStep === 3 && (
            ...
            >
              ...
              <button
                ...
                onClick={() => {
                  setCurrentStep(1);
                  // Idéalement, réinitialiser l'état du formulaire ici si ce n'est pas géré par useEffect
                }}
